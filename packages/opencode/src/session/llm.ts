...
import { AgentOSLanguageModel } from "@/provider/sdk/agentos/agentos-language-model"
...
export namespace LLM {
  ...
  /**
   * Continue a paused AgentOS run after tool confirmation.
   * Processes the continued stream and returns the accumulated content.
   */
  export async function continueAgentOS(input: {
    model: Provider.Model
    ...
    if (!(language instanceof AgentOSLanguageModel)) {
